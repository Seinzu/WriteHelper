...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
		<?php 	
			...
			jQuery('body').delegate('#submitsection<?php echo $model->id; ?>','click',function(){jQuery.ajax({'type':'POST','url':'<?php echo CHtml::normalizeUrl(array('ajax/createSection'));?>','success':function(data){sectionUpdate(data);},'cache':false,'dataType':'json','data':jQuery(this).parents("form").serialize()});return false;});
			</script>
	</div>
